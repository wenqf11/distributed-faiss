...
class IndexIVF(Index):
    ...
    if _newclass:
        clustering_index = _swig_property(_swigfaiss_gpu.IndexIVF_clustering_index_get, _swigfaiss_gpu.IndexIVF_clustering_index_set)
    ...
    if _newclass:
        codes = _swig_property(_swigfaiss_gpu.IndexIVF_codes_get, _swigfaiss_gpu.IndexIVF_codes_set)
...
class IndexIVFPQ(IndexIVF):
    ...
    def search_and_reconstruct(self, n, x, k, distances, labels, reconstructed):
        return _swigfaiss_gpu.IndexIVFPQ_search_and_reconstruct(self, n, x, k, distances, labels, reconstructed)
...
class IndexIVFPQCompact(IndexIVFPQ):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs):
        return _swigfaiss_gpu.IndexIVFPQCompact_search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs)
