...
class IndexIVF(Index):
    ...
    if _newclass:
        clustering_index = _swig_property(_swigfaiss.IndexIVF_clustering_index_get, _swigfaiss.IndexIVF_clustering_index_set)
...
class IndexIVFPQ(IndexIVF):
    ...
    def search_and_reconstruct(self, n, x, k, distances, labels, reconstructed):
        return _swigfaiss.IndexIVFPQ_search_and_reconstruct(self, n, x, k, distances, labels, reconstructed)
